...
@Injectable()
export class TelephoneBookServiceProxy {
    private http: HttpClient;
    private baseUrl: string;
    protected jsonParseReviver: ((key: string, value: any) => any) | undefined = undefined;
    ...
    /**
     * @telephoneBook (optional) 
     * @return Success
     */
    createOrUpdate(telephoneBook: TelephoneBookDto | null | undefined): Observable<void> {
        let url_ = this.baseUrl + "/api/services/app/TelephoneBook/CreateOrUpdate";
        url_ = url_.replace(/[?&]$/, "");

        const content_ = JSON.stringify(telephoneBook);
     ...
     * @return Success
     */
    getForEdit(id: string | null | undefined): Observable<TelephoneBookDto> {
        let url_ = this.baseUrl + "/api/services/app/TelephoneBook/GetForEdit?";
        if (id !== undefined)
            url_ += "Id=" + encodeURIComponent("" + id) + "&"; 
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return <Observable<TelephoneBookDto>><any>_observableThrow(e);
                }
            } else
                return <Observable<TelephoneBookDto>><any>_observableThrow(response_);
        }));
    }

    protected processGetForEdit(response: HttpResponseBase): Observable<TelephoneBookDto> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = resultData200 ? TelephoneBookDto.fromJS(resultData200) : new TelephoneBookDto();
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
        ...
        return _observableOf<TelephoneBookDto>(<any>null);
    }
    ...
    delete(id: string | null | undefined): Observable<void> {
        let url_ = this.baseUrl + "/api/services/app/TelephoneBook/Delete?";
        if (id !== undefined)
            url_ += "Id=" + encodeURIComponent("" + id) + "&"; 
        url_ = url_.replace(/[?&]$/, "");
     ...
     * @return Success
     */
    getAllTelephoneBookList(): Observable<TelephoneBookListDto[]> {
        let url_ = this.baseUrl + "/api/services/app/TelephoneBook/GetAllTelephoneBookList";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processGetAllTelephoneBookList(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetAllTelephoneBookList(<any>response_);
                } catch (e) {
                    return <Observable<TelephoneBookListDto[]>><any>_observableThrow(e);
                }
            } else
                return <Observable<TelephoneBookListDto[]>><any>_observableThrow(response_);
        }));
    }

    protected processGetAllTelephoneBookList(response: HttpResponseBase): Observable<TelephoneBookListDto[]> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            if (resultData200 && resultData200.constructor === Array) {
                ...
                for (let item of resultData200)
                    result200.push(TelephoneBookListDto.fromJS(item));
            }
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
        ...
        return _observableOf<TelephoneBookListDto[]>(<any>null);
    }
}
...
export class TelephoneBookDto implements ITelephoneBookDto {
    name: string | undefined;
    emailAddress: string | undefined;
    tel: string | undefined;
    id: string | undefined;

    constructor(data?: ITelephoneBookDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): TelephoneBookDto {
        data = typeof data === 'object' ? data : {};
        let result = new TelephoneBookDto();
        result.init(data);
        return result;
    }
...
export interface ITelephoneBookDto {
    name: string | undefined;
    emailAddress: string | undefined;
    tel: string | undefined;
    id: string | undefined;
...
export class TelephoneBookListDto implements ITelephoneBookListDto {
    name: string | undefined;
    emailAddress: string | undefined;
    tel: string | undefined;
    ...
    constructor(data?: ITelephoneBookListDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): TelephoneBookListDto {
        data = typeof data === 'object' ? data : {};
        let result = new TelephoneBookListDto();
        result.init(data);
        return result;
    }
...
export interface ITelephoneBookListDto {
    name: string | undefined;
    emailAddress: string | undefined;
    tel: string | undefined;
    isDeleted: boolean | undefined;
